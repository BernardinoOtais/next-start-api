...
/**
   ...
   * `prisma.papeis`: Exposes CRUD operations for the **Papeis** model.
    ...
    * ```
    */
  get papeis(): Prisma.PapeisDelegate<ExtArgs, { omit: OmitOpts }>;
